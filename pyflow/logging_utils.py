# Pyflow an open-source tool for modular visual programming in python
...
from pyflow.logging_utils import PyflowHandler  # Updated import
...
if __name__ == "__main__":
    ...
    stream_handler = PyflowHandler()  # Updated usage
